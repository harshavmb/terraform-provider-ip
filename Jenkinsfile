                    ...
                    docker.withRegistry("https://${registry}", 'IZ_USER') {
                        docker.image(baseTerraformAutoImage).inside {
                            sh '''
                              ...
                              wget -q -O /tmp/goreleaser.tar.gz https://github.com/goreleaser/goreleaser/releases/download/v1.12.1/goreleaser_Linux_x86_64.tar.gz
                              ...
                              /tmp/goreleaser release --rm-dist --config .goreleaser-jenkins.yml
                        '''
                        }
                    }
                }
