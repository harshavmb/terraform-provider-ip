...
"os": "$1",
"arch": "$2",
"filename": "$PROJECT_NAME_$VERSION_$1_$2.zip",
"download_url": "https://repository.adp.amadeus.net/generic-production-iac/providers/$provider/$PROJECT_NAME/$VERSION/$PROJECT_NAME_$VERSION_$1_$2.zip",
